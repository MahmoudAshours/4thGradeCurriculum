...
1. Attribute is a data field, representing the characteristics or features of data object.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Data mining algorithms must be efficient and scalable in order to effectively extract information from huge amounts of data.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. A major problem with the mean is its sensitivity to extreme (outlier) values.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Blievability reflects how much the data are trusted by users, while interpretability reflects how easy the data are understood.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. clustering means measuring the similarity among a set of attributes to predict similar clusters of a given set of data points.<details> <summary>View answer</summary> :x:
 </details>
1. duplicate records requires data normalization<details> <summary>View answer</summary> :x:
 </details>
1. incomplete data means that it contains errors and outlier.<details> <summary>View answer</summary> :x:
 </details>
1. in cluster technique, one cluster can hold at most one object.<details> <summary>View answer</summary> :x:
 </details>
1. Real world data tend to be dirty, incomplete, and inconsistent.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Good database and data entry procedure design should help maximize the number of missing values or errors.<details> <summary>View answer</summary> :x:
 </details>
1. Redundant data occur often when integrating multiple databases.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Dimensionality reduction may help to eliminate irrelevant features or reduce noise.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Data mining turns a large collection of data into knowledge.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Attribute is a data field, representing the characteristics or features of data object.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Variance and standard deviation are measures of data dispersion.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. A major problem with the mean is its sensitivity to extreme (e.g., outlier) values.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. The Table consists of a set of attributes (rows) and usually stores a large set of tuples columns).<details> <summary>View answer</summary> :x:
 </details>
1. In clustering techniques, one cluster can hold at most one object.<details> <summary>View answer</summary> :x:
 </details>
1. Dimensionality reduction may help to eliminate irrelevant features.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Feature subset selection is another way to reduce dimensionality<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Data visualization aims to communicate data clearly and effectively through graphical representation.<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
1. Ensemble methods can be used to increase overall accuracy by learning and combining a series of individual (base) classifier models.<details> <summary>View answer</summary> :x:
 </details>
1. The learning and classification steps of decision tree induction are complex and slow.<details> <summary>View answer</summary> :x:
 </details>
1. Decision trees and classification rules can be easy to interpret<details> <summary>View answer</summary> :heavy_check_mark:
 </details>
---
...
1. Bayesian classifiers is  
   ...
   *<details> <summary>View answer</summary> Answer:** A
 </details>
1. Algorithm is  
   ...
   *<details> <summary>View answer</summary> Answer:** B
 </details>
1. Classification is  
...
1. Classification task referred to  
   ...
   *<details> <summary>View answer</summary> Answer:** C
 </details>
...
1. Naive prediction is  
   ...
   *<details> <summary>View answer</summary> Answer:** C (مع تحيات حمادة هلال والأسرة الكريمة)
 </details>
...
1. Some telecommunication company wants to segment their customers into distinct groups in order to send appropriate subscription offers, this is an example of  
   ...
   *<details> <summary>View answer</summary> Answer:** D
 </details>
...
1. Which of the following activities is NOT a data mining task? Select one:  
   ...
   *<details> <summary>View answer</summary> Answer:** Extracting the frequencies of a sound wave
 </details>
1. Which of the following is not a data mining task?  
   ...
   *<details> <summary>View answer</summary> Answer:** Feature Subset Detection
 </details>
1. Value set {poor, average, good, excellent} is an example of Select one:  
   ...
   d. Ordinal attribute  
   *<details> <summary>View answer</summary> Answer:** Ordinal attribute
 </details>
1. Which data mining task can be used for predicting wind velocities as a function of temperature, humidity, air pressure, etc.? Select one:  
   ...
   c. Classification  
   d. Sequential pattern discovery  
   *<details> <summary>View answer</summary> Answer:** Regression
 </details>
1. Identify the example of sequence data, Select one:  
   ...
   d. genomic data  
   *<details> <summary>View answer</summary> Answer:** genomic data
 </details>
1. In a data mining task where it is not clear what type of patterns could be interesting, the data mining system should, Select one:  
   ...
   *<details> <summary>View answer</summary> Answer:** allow interaction with the user to guide the mining process
 </details>1. Removing duplicate records is a data mining process called .... Select one:  
   a. data isolation  
   b. recovery  
   c. data pruning  
   d. data cleaning  
   *<details> <summary>View answer</summary> Answer:** data cleaning
 </details>
1. Various visualization techniques are used in .... step of KDD, Select one:  
   ...
   c. transformation  
   d. data mining  
   *<details> <summary>View answer</summary> Answer:** interpretation
 </details>
1. Data set {brown, black, blue, green , red} is example of  
   ...
   c. Numeric attribute  
   d. Nominal attribute  
   *<details> <summary>View answer</summary> Answer:** Nominal attribute
 </details>
1. Which of the following is NOT a data quality related issue?  
   ...
   c. Missing values  
   d. Duplicate records  
   *<details> <summary>View answer</summary> Answer:** Attribute value range
 </details>
1. To detect fraudulent usage of credit cards, the following data mining task should be used  
   ...
   d. feature selection  
   *<details> <summary>View answer</summary> Answer:** Outlier analysis
 </details>
1. Which of the following is NOT example of ordinal attributes? Select one:  
   ...
   c. Zip codes  
   d. Movie ratings  
   *<details> <summary>View answer</summary> Answer:** Zip codes
 </details>
1. Which of the following is not a data pre-processing methods, Select one:  
   ...
   d. Data Reduction  
   *<details> <summary>View answer</summary> Answer:** Data Visualization
 </details>
1. Incorrect or invalid data is known as **\_\_\_**  
   ...
   c. Changing data  
   d. Noisy data  
   *<details> <summary>View answer</summary> Answer:** Noisy data
 </details>
1. Data Visualization in mining cannot be done using  
   ...
   c. Charts  
   d. Photos  
   *<details> <summary>View answer</summary> Answer:** Photos
 </details>
1. Nominal and ordinal attributes can be collectively referred to as \_\_\_ attributes, Select one:  
   ...
   c. qualitative  
   d. optimized  
   *<details> <summary>View answer</summary> Answer:** qualitative
 </details>
1. Identify the example of Nominal attribute  
   ...
   c. Gender  
   d. Mass  
   *<details> <summary>View answer</summary> Answer:** Gender
 </details>
1. Which of the following are descriptive data mining activities?  
   ...
   c. Regression  
   d. Classification  
   *<details> <summary>View answer</summary> Answer:** Clustering
 </details>
1. Which statement is not TRUE regarding a data mining task?  
   ...
   *<details> <summary>View answer</summary> Answer:** Regression is a descriptive data mining task
 </details>1. Which of the following is NOT data mining efficiency/scalability issue?  
   Select one:  
   a. The running time of a data mining algorithm  
   b. Incremental execution  
   c. Data partitioning  
   d. Easy to use user interface  
   *<details> <summary>View answer</summary> Answer:** Easy to use user interface
 </details>
1. Synonym for data mining is  
   ...
   d. OLAP  
   *<details> <summary>View answer</summary> Answer:** Knowledge discovery in database
 </details>
1. Dimensionality reduction reduces the data set size by removing **\_\_\_**  
   ...
   *<details> <summary>View answer</summary> Answer:** irrelevant attributes
 </details>
1. Which of the following is NOT an example of data quality related issue?  
   ...
   *<details> <summary>View answer</summary> Answer:** Multiple date formats
 </details>
1. Similarity is a numerical measure whose value is  
   ...
   *<details> <summary>View answer</summary> Answer:** Higher when objects are more alike
 </details>
1. The dissimilarity between two data objects is  
   ...
   *<details> <summary>View answer</summary> Answer:** Lower when objects are more alike
 </details>1. Which of the following data mining task is known as Market Basket Analysis?  
   Select one:  
   a. Classification  
   b. Regression  
   c. Association Analysis  
   d. Outlier Analysis  
   *<details> <summary>View answer</summary> Answer:** Association Analysis
 </details>
1. The difference between supervised learning and unsupervised learning is given by  
   ...
   *<details> <summary>View answer</summary> Answer:** unlike unsupervised learning, supervised learning needs labeled data
 </details>
1. The Data Sets are made up of  
   ...
   c. Dimensions  
   d. Database  
   *<details> <summary>View answer</summary> Answer:** Data Objects
 </details>
1. …………………. is an essential process where intelligent methods are applied to extract data patterns.  
   ...
   C) Text mining  
   D) Data selection  
   *<details> <summary>View answer</summary> Answer:** B) Data mining
 </details>
1. Data mining can also applied to other forms such as …………….  
   ...
   *<details> <summary>View answer</summary> Answer:** D) All i, ii, iii, iv and v
 </details>
1. Which of the following is not a data mining functionality?  
   ...
   *<details> <summary>View answer</summary> Answer:** C) Selection and interpretation
 </details>
1. ……………………….. is a summarization of the general characteristics or features of a target class of data.  
   ...
   D) Data selection  
   *<details> <summary>View answer</summary> Answer:** A) Data Characterization
 </details>
1. ……………………….. is a comparison of the general features of the target class data objects against the general features of objects from one or multiple contrasting classes.  
   ...
   C) Data discrimination  
   D) Data selection  
   *<details> <summary>View answer</summary> Answer:** C) Data discrimination
 </details>
1. ……………………….. is the process of finding a model that describes and distinguishes data classes or concepts.  
   ...
   C) Data discrimination  
   D) Data selection  
   *<details> <summary>View answer</summary> Answer:** B) Data Classification
 </details>
1. The various aspects of data mining methodologies is/are ……………….  
   ...
   *<details> <summary>View answer</summary> Answer:** D) All i, ii, iii and iv
 </details>
1. The full form of KDD is ………………  
   ...
   *<details> <summary>View answer</summary> Answer:** B) Knowledge Discovery Database
 </details>
1. The output of KDD is ………….  
   ...
   *<details> <summary>View answer</summary> Answer:** D) Useful information
 </details>
...
1. \_\_\_\_\_ predicts future trends &behaviors, allowing business managers to make proactive,knowledge-driven decisions.  
   ...
   D. Metadata.  
   *<details> <summary>View answer</summary> Answer:** B
 </details>1. Capability of data mining is to build **\_\_** models.  
   A. retrospective.  
   B. interrogative.  
   C. predictive.  
   D. imperative.  
