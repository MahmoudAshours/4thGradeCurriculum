...
1. Attribute is a data field, representing the characteristics or features of data object. 

1. Data mining algorithms must be efficient and scalable in order to effectively extract information from huge amounts of data. 

1. A major problem with the mean is its sensitivity to extreme (outlier) values. 

1. Blievability reflects how much the data are trusted by users, while interpretability reflects how easy the data are understood. 
...
1. Data mining turns a large collection of data into knowledge. 

1. Attribute is a data field, representing the characteristics or features of data object. 

1. Variance and standard deviation are measures of data dispersion. 

1. A major problem with the mean is its sensitivity to extreme (e.g., outlier) values. 

1. The Table consists of a set of attributes (rows) and usually stores a large set of tuples columns). 

1. In clustering techniques, one cluster can hold at most one object. 

1. Dimensionality reduction may help to eliminate irrelevant features. 
...
1. Ensemble methods can be used to increase overall accuracy by learning and combining a series of individual (base) classifier models. 

1. The learning and classification steps of decision tree induction are complex and slow. 

1. Decision trees and classification rules can be easy to interpret 
...
1. Naive prediction is  
   ...
   C. A prediction made using an extremely simple method, such as always predicting the same output.
    ...
    (مع تحيات حمادة هلال والأسرة الكريمة)
